# Now
- Student: try it! Run `python3 server.py`, open http://localhost:8000, press Start

# Next
- Student: create a free Freesound account and API key, then put it in `.env` (see README)
- Tune the feel together (sensitivity, pitch range, how easy fist/✌️ are to trigger)
